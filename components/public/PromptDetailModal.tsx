            ...
            {visiblePins.map((pin) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-between p-3 pointer-events-none">
                    {/* Top Actions: Bookmark & Quick Copy */}
                    <div className="flex items-center justify-between w-full pointer-events-auto">
                      <span className="px-2 py-0.5 rounded-full bg-black/60 backdrop-blur-md text-[10px] font-bold text-white/90">
                        {pin.category}
                      </span>
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className={`p-2 rounded-full backdrop-blur-md shadow-md transition-all hover:scale-110 ${
                            isCopied
                              ? 'bg-emerald-600 text-white'
                        ...
                        <button
                          ...
                          title={isPinBookmarked ? 'Remove Bookmark' : 'Save Pin'}
                        >
                          <Bookmark className={`w-3.5 h-3.5 ${isPinBookmarked ? 'fill-current' : ''}`} />
                        </button>
                      </div>
                    </div>
